...
<head>
    ...
    <title>Register | Welcome to Registration!</title>
                            ...
                            <div class="col-lg-6">
                                <div class="login-bg">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="logo">
                                                <h3 style="font-weight: bold;color: blue">Welcome to Registration!</h3>
                                                <hr />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="login-title">
                                                <h1 style="color: red">Hospital User Registration Form</h1>
                                            </div>
                                        </div>
                                    </div>
