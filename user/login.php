...
if(isset($_POST['login'])) 
  {
    ...
    $sql ="SELECT ID FROM tbluser WHERE MobileNumber=:mobno and Password=:password and email=:email";
...
<head>
    ...
    <title>Login | Welcome to Login</title>
            ...
            <div class="login-form-area mg-t-30 mg-b-40">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <form class="adminpro-form" method="post" name="login" action="dashboard.php">
                            <div class="col-lg-4">
                                <div class="login-bg">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="logo">
                                                <h3 style="font-weight: bold;color: blue">Welcome to Login!</h3>
                                                <hr />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="login-title">
                                                <h1 style="color: red">Hospital User Login Form</h1>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                     ...
                                     <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="login-input-area">
                                                <input type="email" name="email" maxlength="25" required="true" />
                                                <i class="fa fa-mobile login-user" aria-hidden="true"></i>
                                            </div>
                                        </div>
                                    </div>
